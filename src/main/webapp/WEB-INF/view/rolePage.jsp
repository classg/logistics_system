...
<div class="page-container">
    <span id="toolbar" class="l">
	 	...
	 	<a href="javascript:;" onclick="role_add()" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a>
	 </span>
...
<script type="text/javascript">
    ...
    $(function() {
        $('#userTable').bootstrapTable({
            url: 'role/list.do',// 发送过来的ajax数据的地址
            /**
             * ajax请求以后回调函数的处理
    ...
    function operationFormatter(value,row,index){
        var html = "";
        html += "<span onclick='role_edit("+value+")' style='color: green; cursor: pointer' class='glyphicon glyphicon-pencil' />";
        html += "<span onclick='role_del("+value+")' style='color: red; margin-left: 30px; cursor: pointer' class='glyphicon glyphicon-trash' />";
        return html;
    }
    ...
    */
    /*管理员-增加*/
    function role_add(){
        layer_show("新增管理员","role/edit.do",800,500);
    }
    /*管理员-编辑*/
    ...
    function role_del(roleId){
        layer.confirm('亲，请问您确认要删除吗',function(index){
            $.post("role/role_del.do",{"roleId":roleId},function(data){
                // 弹出一个提示框("内容"，时间等)
