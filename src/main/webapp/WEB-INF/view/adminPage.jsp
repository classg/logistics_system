...
<script type="text/javascript">
    ...
    $(function() {
        $('#userTable').bootstrapTable({
            url: 'admin/list.do',// 发送过来的ajax数据的地址
            /**
             * ajax请求以后回调函数的处理
    ...
    function operationFormatter(value,row,index){
        var html = "";
        html += "<span onclick='admin_edit("+value+")' style='color: green; cursor: pointer' class='glyphicon glyphicon-pencil' >&nbsp;&nbsp;&nbsp;";
        html += "<span onclick='admin_del("+value+")' style='color: red; cursor: pointer' class='glyphicon glyphicon-trash' >";
        return html;
    }
    ...
    */
    ...
    function admin_del(userId){
        layer.confirm('亲，请问您确认要删除吗',function(index){
            $.post("admin/admin_del.do",{"userId":userId},function(data){
                // 弹出一个提示框("内容"，时间等)
